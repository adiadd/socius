...
export async function generateMetadata({ params }: ModelResultsPageProps): Promise<Metadata> {
...
export default async function ModelResultsPage({ params }: ModelResultsPageProps) {
    const resolvedParams = await params;
    const { categoryId, scenarioId, modelId } = resolvedParams;
    ...
    if (!scenarioResult.modelResults || typeof scenarioResult.modelResults !== 'object') {
        return (
    ...
    const modelResults = scenarioResult.modelResults[modelId] as Record<string, any>;
    ...
    const sortedDates = Object.keys(modelResults).sort((a, b) => b.localeCompare(a));
    ...
    return (
        <div className="max-w-4xl mx-auto p-6">
            ...
            {/* Header section */}
            <div className="mb-8">
                <h1 className="text-2xl font-bold mb-2">{modelName} ({modelId})</h1>
                    ...
                    return (
                        ...
                        >
                            <div className="flex flex-col md:flex-row md:justify-between md:items-center mb-4">
                                ...
                                <p className="text-sm text-muted-foreground">{responseTime}s response time</p>
                            </div>
