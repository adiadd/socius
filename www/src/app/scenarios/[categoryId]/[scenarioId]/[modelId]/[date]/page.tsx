...
export default async function ScenarioResultPage({
    ...
    const promptContent = (
        <div className="border border-black dark:border-white p-6 rounded-md bg-gray-50 dark:bg-gray-900 shadow-sm">
            ...
            >
                <ReactMarkdown rehypePlugins={[rehypeRaw, rehypeHighlight]} key="model-prompt-markdown">
    ...
    const responseContentElement = (
        <div className="border border-black dark:border-white p-6 rounded-md bg-gray-50 dark:bg-gray-900 shadow-sm">
            ...
            >
                <ReactMarkdown rehypePlugins={[rehypeRaw, rehypeHighlight]} key="model-response-markdown">
                    {responseContent}
                </ReactMarkdown>
            </div>
        </div>
        ...
        <div className="max-w-4xl mx-auto p-6">
            ...
            <div className="flex flex-col gap-8">
                ...
                <CollapsibleSection title="Prompt" defaultOpen={false}>
                    <div key="model-prompt-container">
                        {promptContent}
                    </div>
                </CollapsibleSection>
                ...
                <CollapsibleSection title="Response" defaultOpen={true}>
                    <div key="model-response-container">
